...
const highlights = [
  {
    ...
    description:
      "Receive your books anywhere in Bangladesh within 3-5 business days.",
    icon: Truck,
  },
  {
    title: "Guaranteed Authenticity",
    description:
      "We partner directly with publishers to ensure every copy is original.",
    icon: ShieldCheck,
  },
  {
    title: "Exclusive Member Rewards",
    description:
      "Earn points on every order and unlock seasonal gifts and discounts.",
    icon: Gift,
  },
];
...
const Highlights = () => {
  return (
    <PageLayout>
      <div className="grid gap-8 rounded-3xl lg:grid-cols-3">
