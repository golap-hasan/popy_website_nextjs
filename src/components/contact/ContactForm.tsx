        ...
        <Card className="border-border/60 bg-muted/30 shadow-none">
          <CardContent className="space-y-4 p-6 text-sm text-muted-foreground">
            <div>
              ...
              <p>Need order help right away? Reach out via phone or Messenger for faster responses.</p>
            </div>
            <Separator />
            <ul className="space-y-3 text-sm">
              <li>
                <span className="font-semibold text-foreground">Customer care:</span> +880 9606-787878
              </li>
              <li>
                <span className="font-semibold text-foreground">Messenger:</span> m.me/popylibrary
              </li>
              <li>
                <span className="font-semibold text-foreground">Email:</span> support@popylibrary.com
              </li>
            </ul>
            <Separator />
            <div className="space-y-2 text-xs">
              <p className="font-semibold uppercase tracking-wide text-primary/70">Office hours</p>
