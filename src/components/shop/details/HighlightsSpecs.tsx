...
const HighlightsSpecs = ({ detail }: { detail: Book }) => {
  return (
      ...
      <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
        <div className="space-y-2">
          ...
          <h2 className="text-2xl font-semibold text-foreground md:text-3xl">
            Build better study rituals
          </h2>
          <p className="max-w-2xl text-sm text-muted-foreground">
            Every chapter is designed to move learners from passive reading to
            confident expression. These highlights and specs give you a quick
            feel for how the book is structured.
          </p>
        </div>
      </div>
