      ...
      <div className="space-y-6">
          ...
          <CardContent className="space-y-6">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="rounded-2xl border border-border/40 bg-background/70 p-4 text-xs text-muted-foreground sm:max-w-xs">
                <p className="font-semibold text-foreground">What readers highlight most</p>
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            <h3 className="text-lg font-semibold text-foreground">Learner & mentor reviews</h3>
            <p className="text-sm text-muted-foreground">
              Recent reflections from the community. New reviews arrive every week.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {detail.reviews.map((review) => (
              <Card key={`${review.reviewer}-${review.date}`} className="border-border/50 bg-background/92 p-0">
