      ...
      <div className="space-y-8">
        <div className="space-y-2">
          ...
          <p className="max-w-3xl text-sm text-muted-foreground">
            Find answers quickly or reach out to our team for assistance.
          </p>
        </div>
        <Separator />
          ...
          <Card className="border-border/50 bg-background/95">
            <CardContent className="space-y-3 p-6">
              ...
              <p className="text-sm text-muted-foreground">
                Can&apos;t find what you need? Reach us and we&apos;ll help you
                resolve it.
              </p>
              <div className="flex gap-3">
                ...
                <Button variant="outline" className="rounded-full px-6">
                  <Link href="tel:+8801234567890">Call hotline</Link>
                </Button>
              </div>
            </CardContent>
          </Card>
